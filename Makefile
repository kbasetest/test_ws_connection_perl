SERVICE = test_ws_connection_perl
SERVICE_CAPS = test_ws_connection_perl
SPEC_FILE = test_ws_connection_perl.spec
URL = https://kbase.us/services/test_ws_connection_perl
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
